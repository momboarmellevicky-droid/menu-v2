...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const isUnhelpful = !rawMessage || rawMessage.trim() === '{}' || rawMessage.trim() === '[object Object]'
      setError(isUnhelpful ? "Le service d'authentification rencontre un problème temporaire. Réessayez dans quelques instants." : rawMessage)
    } finally {
      setLoading(false)
    }
  }
